-- models/staging/mc/stg_mc__products.sql
-- Normaliza productos Carozzi desde bronze.ecommerce (entity='products')
-- Incluye resolución del árbol de categorías (levels 2-4) + category_ids del producto
-- Nota: marca viene como ID numérico en custom_attributes (diferente a PF que tiene texto)
...
extracted AS (
    SELECT
        ...
        -- marca viene como ID numérico — se deja como string
        (
